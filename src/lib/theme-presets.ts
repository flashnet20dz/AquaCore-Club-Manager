...
export function generateTokens(
  ...
  return {
    ...
    // Light theme: elegant soft slate-mist canvas with depth, not stark blinding white
    background: oklch(0.954, 0.013, pH),
    foreground: oklch(0.18, 0.03, pH),
    card: oklch(0.998, 0.002, pH),
    cardForeground: oklch(0.18, 0.03, pH),
    popover: oklch(0.998, 0.002, pH),
    popoverForeground: oklch(0.18, 0.03, pH),
    muted: oklch(0.925, 0.016, pH),
    mutedForeground: oklch(0.48, 0.025, pH),
    border: oklch(0.875, 0.018, pH),
    input: oklch(0.915, 0.015, pH),
    ring: oklch(pL, pC, pH),
    destructive: oklch(0.6, 0.22, 25),
    success: oklch(0.62, 0.18, 145),
    warning: oklch(0.72, 0.16, 75),
    info: oklch(0.58, 0.16, 255),
    // Dark theme: Deep Oceanic Midnight Abyss with luminous accents
    backgroundDark: oklch(0.115, 0.026, pH),
    foregroundDark: oklch(0.98, 0.005, pH),
    cardDark: oklch(0.155, 0.028, pH),
    cardForegroundDark: oklch(0.98, 0.005, pH),
    popoverDark: oklch(0.155, 0.028, pH),
    popoverForegroundDark: oklch(0.98, 0.005, pH),
    primaryDark: oklch(Math.min(pL + 0.18, 0.75), pC, pH),
    secondaryDark: oklch(sL, sC, sH),
    accentDark: oklch(aL, aC, aH),
    mutedDark: oklch(0.20, 0.025, pH),
    mutedForegroundDark: oklch(0.70, 0.018, pH),
    borderDark: oklch(0.25, 0.032, pH),
    inputDark: oklch(0.22, 0.028, pH),
    ...
    sidebarDark: oklch(0.13, 0.025, pH),
    sidebarForegroundDark: oklch(0.98, 0.005, pH),
    sidebarPrimaryDark: oklch(Math.min(pL + 0.18, 0.75), pC, pH),
    sidebarAccentDark: oklch(0.22, 0.032, pH),
    sidebarBorderDark: oklch(0.25, 0.032, pH),
  };
}
