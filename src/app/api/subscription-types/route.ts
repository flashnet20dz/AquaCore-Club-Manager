...
const DEFAULT_TYPES = [
  ...
  },
  {
    ...
    code: "DJS",
    color: "#d946ef",
    description: "اشتراك مخفض — رسوم 300/500 دج حسب العمر",
    subscriptionFee: 300,
    subscriptionFeeOver14: 500,
    hasAgeBasedFee: true,
    insuranceFee: 500,
    compoundRights: 0,
    durationDays: 30,
  ...
  },
  {
    ...
    subscriptionFee: 0,
    subscriptionFeeOver14: 0,
    hasAgeBasedFee: false,
    insuranceFee: 0,
    compoundRights: 0,
    durationDays: 30,
    givesMembershipNumber: true,
  ...
  try {
    ...
    const type = await db.subscriptionType.create({
      data: {
        ...
        hasAgeBasedFee: body.hasAgeBasedFee ?? false,
        subscriptionFeeOver14: body.subscriptionFeeOver14 ?? 0,
      },
    });
