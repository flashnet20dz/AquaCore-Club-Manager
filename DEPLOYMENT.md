...
## 🔐 الخطوة 6: إدارة الحسابات والأمان

بعد تهيئة الموقع والنشر:
1. سجّل الدخول بحساب المدير الذي قمت بإنشائه (أو أنشئ النادي عبر `/register-club`).
2. اذهب إلى تبويب "المستخدمون".
3. تأكد من ضبط كلمات مرور قوية لجميع المستخدمين.
4. أنشئ حسابات للموظفين الفعليين بالصلاحيات المناسبة.
...
2. سجّل الدخول بحساب المدير الخاص بك
3. تحقق من:
   - ✅ تظهر لوحة التحكم
